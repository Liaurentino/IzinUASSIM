    ...
    <div class="main-card p-8 rounded-2xl shadow-xl w-full max-w-4xl transition duration-300 space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div class="flex flex-col items-center justify-center space-y-4">
                <img src="https://i.pinimg.com/1200x/db/99/2d/db992dccab92540d10afc25616a2c4cd.jpg" alt="Join Mitra" class="rounded-2xl shadow-2xl object-cover w-full max-w-sm">
