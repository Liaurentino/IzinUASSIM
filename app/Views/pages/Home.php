<div class="main-content space-y-8">
    ...
    <section class="card-section">
        ...
        <div class="content-left">
            <h1 class="home-title text-secondary-purple">
                Laptop Rusak? <br> 
                <span class="text-primary-blue">Servify solusinya</span>
            </h1>
            <p class="home-desc">
    ...
    <section class="card-section">
        ...
        <!-- Kanan: Gambar & CTA -->
        <div class="content-right">
            <!-- Placeholder Image (Menggantikan base64 yang rusak) -->
            ...
            <a href="<?= base_url('merchant') ?>" class="btn-action btn-purple" style="margin-top: 2rem; width: 100%;">
                Gabung Sekarang
            </a>
        </div>
    </section>
